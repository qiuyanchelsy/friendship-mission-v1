...
function stage({panel='',dialogue='',mode='',expression='friendly',step=1,turn='兩人一起',showCharacter=true,location=''}){
 ...
 const figures=showCharacter?(duo?'<div class="vn-person player-person '+(mine?'speaking':'listening')+'"><img class="'+(faceRight?'':'mirror')+'" src="'+sprite(c)+'" alt="'+c.name+'"></div><div class="vn-person npc-person '+(!mine?'speaking':'listening')+'"><img src="assets/vn-xiaozhe-friendly.png" alt="小哲拿著星星鉛筆盒"></div>':single?'<div class="vn-person solo-person"><img class="'+(faceRight?'':'mirror')+'" src="'+sprite(c)+'" alt="'+c.name+'"></div>':''):'';
